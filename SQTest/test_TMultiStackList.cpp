...
class TMultiStackListTest : public ::testing::Test {
protected:
  void SetUp() override {
...
TEST_F(TMultiStackListTest, DefaultConstructor) {
  TMultiStackList<int> stack;
...
TEST_F(TMultiStackListTest, ParameterizedConstructor) {
  TMultiStackList<int> stack(100, 4);
  EXPECT_EQ(stack.GetSize_M(), 0);
...
TEST_F(TMultiStackListTest, CopyConstructor) {
  TMultiStackList<int> original(100, 3);
  original.Put_M(0, 10);
  original.Put_M(1, 20);

  TMultiStackList<int> copy(original);
...
TEST_F(TMultiStackListTest, MoveConstructor) {
  TMultiStackList<int> original(100, 2);
  original.Put_M(0, 5);
  original.Put_M(1, 15);

  TMultiStackList<int> moved(std::move(original));
...
TEST_F(TMultiStackListTest, PutAndGet) {
  TMultiStackList<int> stack(50, 2);
...
TEST_F(TMultiStackListTest, IsFullIsEmpty) {
  TMultiStackList<int> stack(10, 2);
...
TEST_F(TMultiStackListTest, StackOperations) {
  TMultiStackList<int> stack(30, 2);
...
TEST_F(TMultiStackListTest, RepackTest) {
  TMultiStackList<int> stack(20, 2);
...
TEST_F(TMultiStackListTest, ComparisonOperators) {
  TMultiStackList<int> stack1(50, 3);
  TMultiStackList<int> stack2(50, 3);
  TMultiStackList<int> stack3(100, 2);
...
TEST_F(TMultiStackListTest, ExceptionHandling) {
  TMultiStackList<int> stack(10, 2);
...
TEST_F(TMultiStackListTest, OutputOperator) {
  TMultiStackList<int> stack(20, 2);
  stack.Put_M(0, 1);
  stack.Put_M(1, 2);
...
// Test edge cases
TEST_F(TMultiStackListTest, EdgeCases) {
  // Test with zero capacity
  TMultiStackList<int> stack1(0, 0);
  EXPECT_TRUE(stack1.IsEmpty_M());
  EXPECT_EQ(stack1.GetCapacity_M(), 0);

  TMultiStackList<int> stack2(10, 1);
  stack2.Put_M(0, 42);
...
TEST_F(TMultiStackListTest, DifferentDataTypes) {
  TMultiStackList<double> doubleStack(20, 2);
  ...
  TMultiStackList<std::string> stringStack(30, 2);
